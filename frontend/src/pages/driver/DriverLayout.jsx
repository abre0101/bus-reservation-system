...
const DriverLayout = ({ children }) => {
  ...
  const menuItems = [
    ...
    { path: '/driver/trips', icon: '🚌', label: 'My Trips' },
        ...
        <div className="px-4 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <h1 className="text-2xl font-bold">EthioBus Driver</h1>
            </div>
            
            <div className="flex items-center space-x-4">
              <div className="text-right">
                <p className="font-semibold">{user?.full_name || user?.name || 'Driver'}</p>
                <p className="text-sm text-blue-200">{user?.license_number || ''}</p>
              </div>
              <button
